...
function updateStaticCalendarCopy(html) {
  return html
    ...
    .replace("Les angles sont bilingues et prêts à être finalisés une fois la preuve, le visuel et l’approbation confirmés.", "Les angles sont bilingues et prêts à être finalisés une fois la preuve, le visuel et l’approbation confirmés. Certaines journées proposent deux options exclusives : la direction en choisit une seule.")
