...
const RELEASE = "20260910-b82";
const CACHE = "bleu-massawippi-cockpit-shell-v114";
const SHELL = [
  `./feedback-widget.mjs?v=${RELEASE}`, `./editorial-cycle-guard.mjs?v=${RELEASE}`,
  `./event-context-window.mjs?v=${RELEASE}`,
  "./workspace-adapter.js?v=20260910-v2.11", "./workspace-v2.js?v=20260910-v2.11", "./workspace-v2.css?v=20260910-v2.11", "./workspace-model.mjs",
