...
const RELEASE = "20260907-b78";
const CACHE = "bleu-massawippi-cockpit-shell-v110";
const SHELL = [
  `./event-context-window.mjs?v=${RELEASE}`,
  "./workspace-adapter.js?v=20260907-v2.8", "./workspace-v2.js?v=20260907-v2.8", "./workspace-v2.css?v=20260907-v2.8", "./workspace-model.mjs",
