...
const RELEASE = "20260907-b76";
const CACHE = "bleu-massawippi-cockpit-shell-v108";
const SHELL = [
  `./event-context-window.mjs?v=${RELEASE}`,
  "./workspace-adapter.js?v=20260907-v2.6", "./workspace-v2.js?v=20260907-v2.6", "./workspace-v2.css?v=20260907-v2.6", "./workspace-model.mjs",
