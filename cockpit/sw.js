...
const RELEASE = "20260714-a12";
const CACHE = "bleu-massawippi-cockpit-shell-v50";
const SHELL = [
  "./", "./index.html", `./firebase-config.js?v=${RELEASE}`, `./theme.js?v=${RELEASE}`, `./motion.js?v=${RELEASE}`,
  `./cockpit-ui.js?v=${RELEASE}`, `./firebase-client.js?v=${RELEASE}`, `./event-context-data.js?v=${RELEASE}`, `./action-items-ui.js?v=${RELEASE}`, `./client-health-ui.js?v=${RELEASE}`, `./admin-lazy-data.js?v=${RELEASE}`, `./admin-activity-summary.js?v=${RELEASE}`, `./media-choice-ui.js?v=${RELEASE}`, `./view-mode.js?v=${RELEASE}`, "./view-mode.css",
