...
const RELEASE = "20260907-b77";
const CACHE = "bleu-massawippi-cockpit-shell-v109";
const SHELL = [
  `./event-context-window.mjs?v=${RELEASE}`,
  "./workspace-adapter.js?v=20260907-v2.7", "./workspace-v2.js?v=20260907-v2.7", "./workspace-v2.css?v=20260907-v2.7", "./workspace-model.mjs",
