...
assert.equal(contentNotices.notices.length, 18);
assert.ok(contentNotices.notices.every((item) => item.audienceRole === "director" && item.assigneeEmail === "dg@bleumassawippi.com"));
for (const id of ["strategic-zeffy-recurring-gifts-v1", "internal-application-funding-nonmunicipal-v1", "internal-poetry-progress-v2", "internal-poetry-progress-v3", "internal-youth-drawing-toolkit-v1", "strategic-guide-pratiques-aquatiques-2026-v1", "internal-lamproie-report-requested-v1", "internal-poetry-progress-20260810-v1", "internal-rain-garden-v7-20260811-v1", "internal-application-working-layout-20260811-v1", "internal-poetry-operations-20260811-v1"]) {
