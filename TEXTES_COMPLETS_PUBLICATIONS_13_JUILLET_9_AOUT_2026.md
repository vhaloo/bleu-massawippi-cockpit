...
## Lundi 13 juillet — Le lac se raconte en données

**Thème :** Éducation  
**Format :** Carrousel 4 cartes · photo terrain + typographie minimale  
**Objectif :** Ouvrir le mois : le suivi scientifique est une attention constante, pas un verdict ponctuel.  
**CTA :** Enregistrer ce repère  
**Visuel final :** Photo authentique d’un prélèvement, d’un carnet de terrain ou d’un disque de Secchi; titre sur image : Lire le lac dans le temps.  
**Texte alternatif :** FR — Matériel de suivi de la qualité de l’eau au bord du lac. / EN — Water-quality monitoring equipment beside the lake.  
**Source de référence :** https://bleumassawippi.com/rapports-et-memoires  
**Préparation :** Exporter un carrousel 4:5 avec une seule idée par carte et le lien vers les rapports dans la légende.

### Légende prête à programmer

```text
FR — Un lac ne se résume pas à une impression d’un jour. Pour le comprendre, il faut suivre ses signes dans le temps : la transparence, les nutriments, les conditions observées sur le terrain et bien d’autres repères. C’est cette lecture patiente qui aide à choisir des actions utiles pour le Massawippi.

Consultez les rapports et mémoires : https://bleumassawippi.com/rapports-et-memoires

#BleuMassawippi #LacMassawippi #QualitéDeLEau #Estrie

=========================================

EN — A lake cannot be understood through a single day’s impression. To understand it, we follow signs over time: transparency, nutrients, field conditions and many other indicators. This patient reading helps guide useful action for Massawippi.

Read the reports and briefs: https://bleumassawippi.com/rapports-et-memoires
...
**Objectif :** Humaniser l’action sans publier sur l’équipe interne : donner la parole à un bénévole.  
**CTA :** Découvrir le bénévolat  
**Visuel final :** Portrait autorisé d’une personne bénévole de dos ou mains en action; aucun nom affiché; titre sur image : Un geste pour le lac.  
**Texte alternatif :** FR — Des mains participent à une activité bénévole près du lac. / EN — Hands take part in a volunteer activity near the lake.  
**Source de référence :** https://bleumassawippi.com/benevolat  
**Préparation :** Utiliser une photo avec consentement de diffusion documenté; publier sans nom ni citation personnelle si l’identification n’est pas souhaitée.

### Légende prête à programmer

```text
FR — Protéger le Massawippi repose aussi sur des personnes qui donnent du temps, selon leurs disponibilités et leurs intérêts. La banque de bénévoles permet de recevoir des occasions ciblées, sans obligation de participer à chacune d’elles.

Découvrez les possibilités d’implication : https://bleumassawippi.com/benevolat

#BleuMassawippi #Bénévolat #LacMassawippi #Estrie

=========================================

EN — Protecting Massawippi also relies on people who give their time according to their availability and interests. The volunteer bank shares targeted opportunities, with no obligation to take part in every one of them.

Discover ways to get involved: https://bleumassawippi.com/benevolat
...
**Objectif :** Faire entrer l’expérience personnelle dans le fil sans demander plusieurs actions à la fois.  
**CTA :** Répondre en un mot  
**Visuel final :** Photo paysage réelle du lac, sans personne identifiable; question unique en surimpression : Le Massawippi, pour vous, c’est…  
**Texte alternatif :** FR — Vue calme du lac Massawippi et de ses rives. / EN — A calm view of Lake Massawippi and its shoreline.  
**Source de référence :** Banque photo de l’association — droits documentés  
**Préparation :** Publier aussi une story avec une boîte de réponse; relever les mots récurrents sans reproduire les réponses comme citations sans autorisation.

### Légende prête à programmer

```text
FR — Une couleur, une odeur, un son, un souvenir : quel est le premier mot qui vous vient quand vous pensez au Massawippi?
...
EN — A colour, a scent, a sound, a memory: what is the first word that comes to mind when you think of Massawippi?
...
**Visuel final :** Carrousel de deux cartes : 1. Vrai ou faux? 2. La réponse avec illustration d’un disque de Secchi.  
**Texte alternatif :** FR — Un disque de Secchi est utilisé pour observer la transparence de l’eau. / EN — A Secchi disk is used to observe water transparency.  
**Source de référence :** https://bleumassawippi.com/rapports-et-memoires  
...
```text
FR — Vrai ou faux? Une mesure de transparence suffit à dire si un lac est en santé.
...
EN — True or false? One transparency measurement is enough to tell whether a lake is healthy.
...
**Objectif :** Créer une respiration émotionnelle et une signature visuelle non artificielle.  
**CTA :** Prendre une minute  
**Visuel final :** Reel de 10 à 15 secondes : eau, rive et lumière réelle; aucun texte durant les trois premières secondes, puis Minute bleue.  
**Texte alternatif :** FR — La lumière se reflète sur la surface calme du lac. / EN — Light reflects on the lake’s calm surface.  
...
```text
FR — Aujourd’hui, pas de consigne.
...
**Objectif :** Écouter avant de demander une photo ou un témoignage à la communauté.  
**CTA :** Partager un souvenir en commentaire  
**Visuel final :** Photo d’archive dont le crédit et les droits sont documentés, ou vue actuelle du même secteur; mentionner le crédit dans le visuel.  
**Texte alternatif :** FR — Une vue du lac Massawippi qui invite à partager un souvenir. / EN — A view of Lake Massawippi that invites people to share a memory.  
...
```text
FR — Un lac vit aussi dans les souvenirs.
...
EN — A lake also lives in memory.
...
**Objectif :** Faire aimer une espèce visible du bassin par une image forte, pas une fiche encyclopédique.  
**CTA :** Enregistrer pour la reconnaître  
**Visuel final :** Photo réelle d’iris versicolore dans un milieu humide du bassin versant, sans géolocalisation précise; titre : Un éclat du bassin versant.  
**Texte alternatif :** FR — Un iris versicolore fleurit dans un milieu humide. / EN — A blue flag iris blooms in a wetland.  
**Source de référence :** https://bleumassawippi.com/accueil-1  
...
```text
FR — L’iris versicolore apporte une touche de couleur aux milieux humides du bassin versant.
...
EN — Blue flag iris brings colour to wetlands across the watershed.
...
**Objectif :** Donner une consigne estivale utile dans un ton de compagnon de route.  
**CTA :** Enregistrer la séquence  
**Visuel final :** Carrousel photo réelle : remorque, coque et bouchon de vidange; trois mots sur image : Inspecter. Nettoyer. Vider.  
**Texte alternatif :** FR — Une embarcation et sa remorque sont inspectées avant une mise à l’eau. / EN — A boat and trailer are inspected before launch.  
**Source de référence :** https://www.quebec.ca/agriculture-environnement-et-ressources-naturelles/faune/gestion-faune-habitats-fauniques/gestion-especes-exotiques-envahissantes-animales/lutte/nettoyage-embarcations-nautiques  
...
```text
FR — Le bon départ commence avant la mise à l’eau.
...
Consignes détaillées : https://www.quebec.ca/agriculture-environnement-et-ressources-naturelles/faune/gestion-faune-habitats-fauniques/gestion-especes-exotiques-envahissantes-animales/lutte/nettoyage-embarcations-nautiques

#Prévention #BleuMassawippi #NautismeResponsable #LacMassawippi

=========================================

EN — The right start happens before launch.
...
Detailed guidance: https://www.quebec.ca/agriculture-environnement-et-ressources-naturelles/faune/gestion-faune-habitats-fauniques/gestion-especes-exotiques-envahissantes-animales/lutte/nettoyage-embarcations-nautiques
...
**CTA :** Découvrir les jardins de pluie  
**Visuel final :** Photo réelle d’un jardin de pluie ou d’une zone végétalisée qui reçoit l’eau de ruissellement; titre : Garder l’eau là où elle tombe.  
**Texte alternatif :** FR — Un jardin de pluie végétalisé recueille l’eau de ruissellement. / EN — A planted rain garden receives runoff water.  
**Source de référence :** https://bleumassawippi.com/accueil-1  
...
```text
FR — Après la pluie, l’eau choisit toujours un chemin. Sur une surface imperméable, elle peut entraîner rapidement des sédiments et des polluants vers les fossés, les tributaires et le lac.
...
EN — After the rain, water always finds a path. On impermeable surfaces, it can quickly carry sediment and pollutants toward ditches, tributaries and the lake.
...
**CTA :** Garder ce repère pour votre prochaine sortie  
**Visuel final :** Photo large d’un bateau en déplacement à distance des rives et des autres usagers; titre : Le respect se voit aussi dans le sillage.  
**Texte alternatif :** FR — Une embarcation se déplace sur le lac en laissant un sillage modéré. / EN — A boat moves across the lake with a moderate wake.  
...
```text
FR — Le plaisir sur l’eau se partage.
...
EN — Enjoyment on the water is shared.
...
**Objectif :** Saisir la Journée mondiale de prévention de la noyade avec une information simple et chaleureuse.  
**CTA :** Choisir votre geste de sécurité  
**Visuel final :** Photo de départ au quai : gilets de sauvetage accessibles, météo consultée et équipement rangé; titre : La sécurité fait partie du plaisir.  
**Texte alternatif :** FR — Des gilets de sauvetage sont prêts avant une sortie sur l’eau. / EN — Lifejackets are ready before heading out on the water.  
...
```text
FR — La sécurité fait partie du plaisir. Avant de partir, prenez un moment pour vérifier la météo, l’état de l’embarcation et l’équipement de sécurité. Assurez-vous aussi que chaque personne à bord a un gilet de sauvetage ou un VFI de la bonne taille.
...
EN — Safety is part of the fun. Before leaving, take a moment to check the weather, the condition of the vessel and the safety equipment. Also make sure that every person on board has a properly sized lifejacket or PFD.
...
**CTA :** Suivre le bilan de santé  
**Visuel final :** Carrousel de suivi réel : prélèvement, disque de Secchi, rive et carnet; titre : Ce que nous suivons cet été.  
**Texte alternatif :** FR — Des outils et observations utilisés pour suivre l’état du lac. / EN — Tools and observations used to monitor the lake’s condition.  
**Source de référence :** https://bleumassawippi.com/rapports-et-memoires  
...
```text
FR — Cet été, le suivi du lac se poursuit sur le terrain. On observe, on échantillonne, on mesure et on consigne les conditions qui aideront à comprendre l’évolution du Massawippi.
...
EN — This summer, lake monitoring continues in the field. We observe, sample, measure and record conditions that help us understand Massawippi’s evolution.
...
**Visuel final :** Infographie sobre de trois indicateurs : phosphore total, chlorophylle a et transparence; aucune valeur non approuvée dans le visuel.  
**Texte alternatif :** FR — Une infographie explique que plusieurs indicateurs sont lus ensemble pour suivre le lac. / EN — An infographic explains that several indicators are read together to monitor the lake.  
**Source de référence :** https://bleumassawippi.com/rapports-et-memoires  
...
```text
FR — Un chiffre seul peut attirer l’attention. Trois indicateurs lus ensemble permettent de mieux comprendre.
...
Lire le rapport annuel 2025 : https://bleumassawippi.com/rapports-et-memoires

#QualitéDeLEau #BleuMassawippi #LacMassawippi #ScienceDuLac

=========================================

EN — One number can draw attention. Three indicators read together provide a better understanding.
...
Read the 2025 annual report: https://bleumassawippi.com/rapports-et-memoires
...
**CTA :** Savoir quoi observer  
**Visuel final :** Photo réelle d’une rive après la pluie, sans présenter l’image comme un avis sanitaire; titre : Observer sans paniquer.  
**Texte alternatif :** FR — Une rive du lac après une averse. / EN — A lakeshore after rainfall.  
**Source de référence :** https://bleumassawippi.com/accueil-1  
...
```text
FR — Après une forte pluie, le bon réflexe est d’observer sans tirer de conclusion trop vite. L’eau, les rives et les tributaires réagissent à des conditions qui demandent du contexte et, parfois, des analyses.
...
EN — After heavy rain, the right reflex is to observe without jumping to conclusions. Water, shorelines and tributaries respond to conditions that require context and sometimes analysis.
...
**CTA :** Garder ces trois questions  
**Visuel final :** Infographie de trois questions : Qu’est-ce qui est mesuré? Où et quand? Avec quoi compare-t-on?  
**Texte alternatif :** FR — Trois questions simples aident à lire une donnée sur le lac. / EN — Three simple questions help interpret a lake data point.  
**Source de référence :** https://bleumassawippi.com/rapports-et-memoires  
**Préparation :** Garder le visuel à trois questions et renvoyer vers le rapport officiel pour les détails méthodologiques.

### Légende prête à programmer

```text
FR — Une donnée ne vit jamais seule. Avant de la partager ou de l’interpréter, posons trois questions :
...
EN — A data point never lives alone. Before sharing or interpreting it, ask three questions:
...
## Samedi 1er août — Voix du lac

**Thème :** Communauté  
**Format :** Témoignage citoyen de 15 s ou photo + citation  
**Objectif :** Chercher l’émotion demandée par la direction avec une personne réelle et une phrase forte.  
**CTA :** Écouter / laisser une pensée  
**Visuel final :** Vidéo verticale ou photo de lieu avec une phrase générale sur l’attachement au lac; aucune identité affichée sans autorisation écrite.  
**Texte alternatif :** FR — Une vue paisible du lac accompagne une invitation à partager une pensée. / EN — A peaceful lake view accompanies an invitation to share a thought.  
**Source de référence :** Contenu communautaire — consentement requis avant diffusion  
**Préparation :** Si aucun témoignage autorisé n’est reçu, utiliser la photo de lieu et cette légende telle quelle.

### Légende prête à programmer

```text
FR — Le lac est un milieu vivant, mais aussi un lieu de liens. Il rassemble des habitudes, des paysages et des moments que chacun porte à sa façon.
...
EN — The lake is a living environment, but it is also a place of connection. It brings together routines, landscapes and moments that each person carries in their own way.
...
## Dimanche 2 août — La question du dimanche : quel geste est le plus facile?

**Thème :** Communauté  
**Format :** Photo + choix A/B/C · Story sondage  
**Objectif :** Faire émerger les gestes réalistes plutôt que demander un engagement abstrait.  
**CTA :** Choisir A, B ou C  
**Visuel final :** Visuel typographique A, B, C sur fond de lac : A nettoyer son embarcation, B protéger la rive, C préparer sa sortie.  
**Texte alternatif :** FR — Trois gestes simples sont proposés pour protéger le lac. / EN — Three simple actions are suggested to protect the lake.  
**Source de référence :** https://bleumassawippi.com/accueil-1  
**Préparation :** Utiliser un seul sondage en story et inviter aux commentaires sans organiser de concours ni promettre de prix.

### Légende prête à programmer

```text
FR — La question du dimanche : quel geste vous paraît le plus facile à adopter dès maintenant?
...
EN — Sunday question: which action feels easiest to adopt right now?
...
## Lundi 3 août — Mini-BD : le bon réflexe prend deux secondes

**Thème :** Créatif  
**Format :** BD 3 vignettes · humour doux  
**Objectif :** Introduire l’humour sans ridiculiser les comportements ni inventer une règle.  
**CTA :** Faire défiler la chute  
**Visuel final :** Mini-BD originale en trois cases : 1. On part? 2. Deux secondes, je regarde la remorque. 3. Rien ne part avec nous, sauf de bons souvenirs.  
**Texte alternatif :** FR — Une mini-BD rappelle d’inspecter une remorque avant de partir. / EN — A mini-comic reminds people to inspect a trailer before leaving.  
**Source de référence :** https://www.quebec.ca/agriculture-environnement-et-ressources-naturelles/faune/gestion-faune-habitats-fauniques/gestion-especes-exotiques-envahissantes-animales/lutte/nettoyage-embarcations-nautiques  
**Préparation :** Dessiner une BD originale, sans reprendre de personnage ou d’illustration tiers; conserver les trois cases très lisibles sur mobile.
...
**CTA :** Soutenir le suivi du lac  
**Visuel final :** Carrousel de coulisses réel : bottes, carnet, outil de prélèvement et rive; titre : Les décisions solides commencent dehors.  
**Texte alternatif :** FR — Du matériel de terrain est préparé pour une journée de suivi du lac. / EN — Field equipment is prepared for a lake-monitoring day.  
**Source de référence :** https://bleumassawippi.com/accueil-1  
...
```text
FR — Une décision solide commence rarement derrière un écran. Elle commence sur le terrain : observer, mesurer, comparer, revenir.
...
Soutenir Bleu Massawippi : https://bleumassawippi.com/accueil-1

#Coulisses #BleuMassawippi #LacMassawippi #SoutenirLeLac

=========================================

EN — A sound decision rarely starts behind a screen. It starts in the field: observe, measure, compare, return.
...
Support Bleu Massawippi: https://bleumassawippi.com/home-1
...
**Visuel final :** Carrousel jeu d’observation : rive végétalisée, eau sans déchet visible et embarcation préparée; titre : Cherchez les trois détails.  
**Texte alternatif :** FR — Une scène du lac invite à trouver trois détails qui contribuent à sa protection. / EN — A lake scene invites people to find three details that support protection.  
**Source de référence :** https://bleumassawippi.com/accueil-1  
...
```text
FR — Cherchez les trois détails qui protègent le lac.
...
EN — Find the three details that help protect the lake.
...
**CTA :** Regarder en amont  
**Visuel final :** Photo réelle d’un tributaire ou d’une rive végétalisée en amont; titre : Tout ce qui arrive au lac vient de quelque part.  
**Texte alternatif :** FR — Un cours d’eau et sa végétation rejoignent le bassin versant du lac. / EN — A watercourse and its vegetation flow into the lake’s watershed.  
**Source de référence :** https://bleumassawippi.com/accueil-1  
...
```text
FR — Tout ce qui arrive au lac vient de quelque part. Une goutte tombée sur un toit, un chemin, une pelouse ou une rive peut suivre un parcours vers un fossé, un tributaire puis le Massawippi.
...
EN — Everything that reaches the lake comes from somewhere. A drop falling on a roof, road, lawn or shoreline can travel toward a ditch, a tributary and then Massawippi.
...
## Samedi 8 août — Une journée de terrain en 15 secondes
...
**CTA :** Voir le travail qui se fait dehors  
**Visuel final :** Reel vertical réel de 15 secondes : préparation, observation, mesure, note et rangement; sous-titres FR/EN.  
**Texte alternatif :** FR — Une courte séquence montre les étapes d’une journée de terrain au lac. / EN — A short sequence shows the steps of a lake field day.  
**Source de référence :** https://bleumassawippi.com/rapports-et-memoires  
...
```text
FR — Une journée de terrain en 15 secondes : préparer, observer, mesurer, noter, recommencer.
...
EN — A field day in 15 seconds: prepare, observe, measure, record, repeat.
...
## Dimanche 9 août — Le lac a parlé : que gardons-nous?

**Thème :** Humour  
**Format :** Récapitulatif graphique + question au public  
**Objectif :** Clore le cycle et transformer le mois en apprentissage concret.  
**CTA :** Choisir le format à revoir  
**Visuel final :** Carrousel récapitulatif des quatre formats du mois : données, nature, gestes et terrain; titre : Le lac a parlé. Que gardons-nous?  
**Texte alternatif :** FR — Un récapitulatif visuel des formats de contenu du mois. / EN — A visual recap of the month’s content formats.  
...
```text
FR — Le lac a parlé tout le mois : par les données, les images, les gestes et vos commentaires.
...
EN — The lake has spoken all month long: through data, images, actions and your comments.
