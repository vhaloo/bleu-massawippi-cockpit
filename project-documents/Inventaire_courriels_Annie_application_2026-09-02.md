...
### 11 août 2026 — « résumé de notre rencontre d'hier »

- Pièce jointe : `R_Valentin_10-08-2026.docx`.
- Décision consignée : Annie et Valentin préparent un budget approximatif par phases pour le projet d’application.
- Tâche de communication consignée : produire la mise en page de couverture.

### 17 août 2026 — « voici le résumé concernant le prototype alpha 0.0.1 ... »

- Pièce jointe : `Résumé_ prototype_Alpha.docx`.
- Le document décrit sept livrables proposés : définition des besoins, cartographie des données, architecture préliminaire, maquette de carte, module de signalement citoyen, gouvernance et protection des renseignements, puis prototype visuel avec critères go / no-go.
- La mention « 60–80 % complété » reste une estimation de la direction à vérifier livrable par livrable; elle ne vaut pas preuve technique ni autorisation de développement.

### 2 septembre 2026 — « TR : EcoAction Stream 2 Call for Applications 2027 | Appel de demandes 2027 - ÉcoAction volet 2 »

- Annie propose d’évaluer la carte vivante pour ce programme et relève que le projet doit commencer en 2027.
